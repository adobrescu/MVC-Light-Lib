...
//2. build a complex form for adding an article (with linked records from more than one table)
$userData=new UserFormData(1);

$userData->articles->addNew();
$userData->articles->images->addNew();
...
$userData->articles->images->items(0)->title->showInput();
...
