...
include_once(__DIR__.'/Exception.classes.php');
...
class Object
{
	...
	protected static $___lastInstance;
	...
	public function __construct($gId, $gFlags)
	{
		...
		static::$___lastInstance=static::$___instances[$this->gId]=&$this;
	...
	static public function ___getLastInstance()
	{
		return static::$___lastInstance;
	}
